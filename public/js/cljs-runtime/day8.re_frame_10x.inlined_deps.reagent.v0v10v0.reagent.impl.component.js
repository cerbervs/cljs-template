...
if((i < len)){
var k = (ks[i]);
var G__33457 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__33458 = (i + (1));
m = G__33457;
i = G__33458;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__33397 = c;
var G__33397__$1 = (((G__33397 == null))?null:G__33397.prototype);
if((G__33397__$1 == null)){
return null;
} else {
return G__33397__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__33403 = c;
var G__33403__$1 = (((G__33403 == null))?null:G__33403.prototype);
if((G__33403__$1 == null)){
return null;
} else {
return G__33403__$1.render;
}
})() == null)))));
});
...
var G__33417 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__33417) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.call(null,G__33417));
};
...
var G__33419 = c;
var G__33419__$1 = (((G__33419 == null))?null:G__33419.constructor);
if((G__33419__$1 == null)){
return null;
} else {
return G__33419__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__33423 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__33424 = c;
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__33424);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__33423);
}});
...
var or__4185__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__33451_33483 = goog.object.get(c,"cljsRatom");
if((G__33451_33483 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.dispose_BANG_(G__33451_33483);
}
...
var renders_33485 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_33486 = cljs.core.first(cljs.core.vals(renders_33485));
...
if((cljs.core.count(renders_33485) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_33485))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_33486)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_33486], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var or__4185__auto____$1 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.fun_name(render_fun);
...
var G__33452 = o;
goog.object.set(G__33452,cljs.core.name(k),v);
...
if(cljs.core.truth_(reagent.debug.has_console)){
(cljs.core.truth_(reagent.debug.tracking)?reagent.debug.track_console:console).warn(["Warning: ","Using native React classes directly in Hiccup forms ","is not supported. Use create-element or ","adapt-react-class instead: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4185__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.fun_name(f);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return f;
