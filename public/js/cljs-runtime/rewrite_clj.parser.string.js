...
if((c === "\n")){
var G__35927 = escape_QMARK_;
var G__35928 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__35927;
lines = G__35928;
continue;
} else {
buf.append(c);

var G__35929 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__35930 = lines;
escape_QMARK_ = G__35929;
lines = G__35930;
continue;
...
var G__35914 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__35914) : rewrite_clj.node.string_node.call(null,G__35914));
});
...
var G__35925 = cljs.core.re_pattern(regex);
var G__35926 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__35925,G__35926) : rewrite_clj.node.token_node.call(null,G__35925,G__35926));
});
