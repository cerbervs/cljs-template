...
var vec__39279 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__39282 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39282,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39282,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39279,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39279,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__39285){
var vec__39286 = p__39285;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39286,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39286,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39289,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39289,(1),null);
...
var vec__39296 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39296,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39296,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39296,(2),null);
var vec__39299 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39299,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39299,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39299,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__39311){
var vec__39312 = p__39311;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39312,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39312,(1),null);
...
var len__4789__auto___39393 = arguments.length;
var i__4790__auto___39394 = (0);
while(true){
if((i__4790__auto___39394 < len__4789__auto___39393)){
args__4795__auto__.push((arguments[i__4790__auto___39394]));

var G__39395 = (i__4790__auto___39394 + (1));
i__4790__auto___39394 = G__39395;
continue;
} else {
}
break;
...
var vec__39318 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39318,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39318,(1),null);
...
var G__39321 = zprint.core.parse_string_all_options(rest_options);
var G__39322 = zprint.core.zprint_str_internal;
var G__39323 = ":parse-string-all? call";
var G__39324 = (function (){var G__39325 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39325) : zprint.zutil.edn_STAR_.call(null,G__39325));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__39321,G__39322,G__39323,G__39324) : zprint.core.process_multiple_forms.call(null,G__39321,G__39322,G__39323,G__39324));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__39326 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39326,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39326,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq39315){
var G__39316 = cljs.core.first(seq39315);
var seq39315__$1 = cljs.core.next(seq39315);
var G__39317 = cljs.core.first(seq39315__$1);
var seq39315__$2 = cljs.core.next(seq39315__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39316,G__39317,seq39315__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq39336){
var G__39337 = cljs.core.first(seq39336);
var seq39336__$1 = cljs.core.next(seq39336);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39337,seq39336__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq39339){
var G__39340 = cljs.core.first(seq39339);
var seq39339__$1 = cljs.core.next(seq39339);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39340,seq39339__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___39436 = arguments.length;
var i__4790__auto___39438 = (0);
while(true){
if((i__4790__auto___39438 < len__4789__auto___39436)){
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq39341){
var G__39342 = cljs.core.first(seq39341);
var seq39341__$1 = cljs.core.next(seq39341);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39342,seq39341__$1);
}));
...
var i__4790__auto___39444 = (0);
while(true){
if((i__4790__auto___39444 < len__4789__auto___39442)){
args__4795__auto__.push((arguments[i__4790__auto___39444]));

var G__39447 = (i__4790__auto___39444 + (1));
i__4790__auto___39444 = G__39447;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq39343){
var G__39344 = cljs.core.first(seq39343);
var seq39343__$1 = cljs.core.next(seq39343);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39344,seq39343__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__39346,form){
var vec__39347 = p__39346;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39347,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39347,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39347,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39347,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__39350 = (cljs.core.truth_((function (){var and__4174__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39350,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39350,(1),null);
...
var forms = (function (){var G__39357 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39357) : zprint.zutil.edn_STAR_.call(null,G__39357));
})();
