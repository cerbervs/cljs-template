...
var G__36395 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__36395__$1 = (((G__36395 == null))?null:cljs.core.iterate((function (loc){
...
var G__36395__$2 = (((G__36395__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__36395__$1));
var G__36395__$3 = (((G__36395__$2 == null))?null:cljs.core.last(G__36395__$2));
if((G__36395__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__36395__$3);
}
} else {
return zloc;
}
...
var G__36429 = rewrite_clj.zip.move.right(v);
var G__36430 = rewrite_clj.zip.move.up(v);
loc = G__36429;
parent = G__36430;
continue;
} else {
var G__36431 = rewrite_clj.zip.move.right(v0);
var G__36432 = parent;
loc = G__36431;
parent = G__36432;
continue;
...
var G__36439 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__36440 = rewrite_clj.zip.move.up(v);
loc = G__36439;
parent = G__36440;
continue;
} else {
var G__36441 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__36442 = parent;
loc = G__36441;
parent = G__36442;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__36413 = zloc;
var G__36413__$1 = (((G__36413 == null))?null:rewrite_clj.zip.move.down(G__36413));
var G__36413__$2 = (((G__36413__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__36413__$1,k));
if((G__36413__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__36413__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__36414 = rewrite_clj.zip.move.down(zloc);
var G__36414__$1 = (((G__36414 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__36414));
if((G__36414__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__36414__$1);
}
})(),k);
}
});
