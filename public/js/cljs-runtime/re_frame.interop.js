...
return [(function (){var pred__38246 = cljs.core.instance_QMARK_;
var expr__38247 = reactive_val;
if(cljs.core.truth_((pred__38246.cljs$core$IFn$_invoke$arity$2 ? pred__38246.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__38247) : pred__38246.call(null,reagent.ratom.RAtom,expr__38247)))){
return "ra";
} else {
if(cljs.core.truth_((pred__38246.cljs$core$IFn$_invoke$arity$2 ? pred__38246.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__38247) : pred__38246.call(null,reagent.ratom.RCursor,expr__38247)))){
return "rc";
} else {
if(cljs.core.truth_((pred__38246.cljs$core$IFn$_invoke$arity$2 ? pred__38246.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__38247) : pred__38246.call(null,reagent.ratom.Reaction,expr__38247)))){
return "rx";
} else {
if(cljs.core.truth_((pred__38246.cljs$core$IFn$_invoke$arity$2 ? pred__38246.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__38247) : pred__38246.call(null,reagent.ratom.Track,expr__38247)))){
return "tr";
} else {
return "other";
}
