...
var G__28315 = devtools.prefs.pref(v);
v = G__28315;
continue;
} else {
return v;
...
}catch (e28230){var _e__27562__auto__ = e28230;
return false;
}})();
...
}catch (e28239){var _e__27562__auto__ = e28239;
return false;
}})();
...
}catch (e28243){var _e__27562__auto__ = e28243;
return false;
}}
}
});
...
var vec__28259 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28259,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28259,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28266_SHARP_);
}),template);
});
