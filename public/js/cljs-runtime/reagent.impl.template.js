...
var G__37857 = o;
goog.object.set(G__37857,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__38015__i < G__38015__a.length) {G__38015__a[G__38015__i] = arguments[G__38015__i + 0]; ++G__38015__i;}
  args = new cljs.core.IndexedSeq(G__38015__a,0,null);
} 
...
var args = cljs.core.seq(arglist__38016);
...
var G__37865 = o;
goog.object.set(G__37865,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38024__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__38024 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38025__i = 0, G__38025__a = new Array(arguments.length -  0);
while (G__38025__i < G__38025__a.length) {G__38025__a[G__38025__i] = arguments[G__38025__i + 0]; ++G__38025__i;}
  args = new cljs.core.IndexedSeq(G__38025__a,0,null);
} 
return G__38024__delegate.call(this,args);};
G__38024.cljs$lang$maxFixedArity = 0;
G__38024.cljs$lang$applyTo = (function (arglist__38026){
var args = cljs.core.seq(arglist__38026);
return G__38024__delegate(args);
});
...
var G__37871 = props;
var G__37871__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37871,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37871);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37871__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__37871__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37872 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37872,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37872;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37878){
var map__37879 = p__37878;
var map__37879__$1 = (((((!((map__37879 == null))))?(((((map__37879.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37879.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37879):map__37879);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37879__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__37890_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37890_SHARP_);
}));
} else {
return null;
}
...
var vec__37909 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37909,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37909,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37909,(2),null);
...
var temp__5739__auto___38063 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___38063 == null)){
} else {
var key_38065 = temp__5739__auto___38063;
(jsprops.key = key_38065);
}
...
var temp__5739__auto___38072 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___38072 == null)){
} else {
var key_38073 = temp__5739__auto___38072;
(jsprops.key = key_38073);
}
...
var G__37943 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37943) : reagent.impl.template.as_element.call(null,G__37943));
} else {
var temp__5739__auto___38104 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___38104 == null)){
} else {
var key_38106 = temp__5739__auto___38104;
(jsprops.key = key_38106);
}
...
var G__37954 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__37954)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__37954)){
return x;
} else {
...
var len__4789__auto___38108 = arguments.length;
var i__4790__auto___38109 = (0);
while(true){
if((i__4790__auto___38109 < len__4789__auto___38108)){
args__4795__auto__.push((arguments[i__4790__auto___38109]));

var G__38112 = (i__4790__auto___38109 + (1));
i__4790__auto___38109 = G__38112;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37957){
...
break;
default:
var G__38122 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__38122;
continue;
...
var ctx = ({});
var vec__38001 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38001,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38001,(1),null);
...
var G__38005 = (cljs.core.count(argv) - first_child);
switch (G__38005) {
case (0):
