...
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"day8.re-frame-10x.inlined-deps.reagent.v0v10v0.reagent.impl.template/NativeWrapper");
}));
...
while (G__33566__i < G__33566__a.length) {G__33566__a[G__33566__i] = arguments[G__33566__i + 0]; ++G__33566__i;}
  args = new cljs.core.IndexedSeq(G__33566__a,0,null);
} 
...
var G__33484 = o;
goog.object.set(G__33484,day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.convert_prop_value(v));
...
var G__33487 = props;
var G__33487__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33487,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__33487);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33487__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__33487__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.set_id_class((function (){var G__33488 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33488,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__33488;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v10v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__33492){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33493__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__33499_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_handle_change(this$,on_change,p1__33499_SHARP_);
}));
} else {
return null;
}
...
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"day8.re-frame-10x.inlined-deps.reagent.v0v10v0.reagent.impl.template/HiccupTag");
}));
...
var vec__33515 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33515,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33515,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33515,(2),null);
...
var temp__5739__auto___33620 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___33620 == null)){
} else {
var key_33621 = temp__5739__auto___33620;
(jsprops.key = key_33621);
}
...
var jsprops = (function (){var or__4185__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.convert_prop_value(((hasprops)?props:null));
...
var temp__5739__auto___33625 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___33625 == null)){
} else {
var key_33626 = temp__5739__auto___33625;
(jsprops.key = key_33626);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_(props)));
var jsprops = (function (){var or__4185__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.convert_props(((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return ({});
...
var G__33529 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__33529) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.call(null,G__33529));
} else {
var temp__5739__auto___33635 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___33635 == null)){
} else {
var key_33636 = temp__5739__auto___33635;
(jsprops.key = key_33636);
}
...
var G__33537 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__33537)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__33537)){
return x;
} else {
...
var len__4789__auto___33637 = arguments.length;
var i__4790__auto___33638 = (0);
while(true){
if((i__4790__auto___33638 < len__4789__auto___33637)){
args__4795__auto__.push((arguments[i__4790__auto___33638]));

var G__33639 = (i__4790__auto___33638 + (1));
i__4790__auto___33638 = G__33639;
continue;
} else {
}
break;
...
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4796__auto__);
});
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq33541){
var G__33542 = cljs.core.first(seq33541);
var seq33541__$1 = cljs.core.next(seq33541);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33542,seq33541__$1);
}));
...
break;
default:
var G__33647 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__33647;
continue;
...
var ctx = ({});
var vec__33557 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33557,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33557,(1),null);
...
var G__33560 = (cljs.core.count(argv) - first_child);
switch (G__33560) {
case (0):
