...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__34862_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__34862_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__34862_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__34871){
var vec__34872 = p__34871;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34872,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34872,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__34875,s,color,element,idx){
var map__34876 = p__34875;
var map__34876__$1 = (((((!((map__34876 == null))))?(((((map__34876.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34876.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34876):map__34876);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34876__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34876__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34876__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__34882 = (function (){var or__4185__auto__ = color;
...
var fexpr__34881 = (function (){var G__34883 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__34883) : style_map.call(null,G__34883));
})();
return (fexpr__34881.cljs$core$IFn$_invoke$arity$1 ? fexpr__34881.cljs$core$IFn$_invoke$arity$1(G__34882) : fexpr__34881.call(null,G__34882));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__34885){
var vec__34887 = p__34885;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34887,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34887,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34887,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__34900){
var vec__34907 = p__34900;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34907,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34907,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34907,(2),null);
...
var G__35102 = cljs.core.next(ssv);
var G__35103 = (this_ssv == null);
var G__35104 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
...
var vec__34984 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34984,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34984,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34984,(2),null);
...
var G__35106 = cljs.core.next(remaining_cvec);
var G__35107 = new_idx;
var G__35108 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__35106;
idx = G__35107;
out = G__35108;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__35019,cursor_vec){
var vec__35020 = p__35019;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35020,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35020,(1),null);
var focus_vec = vec__35020;
...
var vec__35025 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35025,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35025,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__35028){
var vec__35029 = p__35028;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35029,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35029,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__35042,existing_count){
var vec__35043 = p__35042;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35043,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35043,(1),null);
...
return cljs.core.filterv((function (p1__35038_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__35038_SHARP_))));
...
var vec__35053 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35053,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35053,(1),null);
var cvec_element = vec__35053;
if((cvec_element == null)){
var G__35151 = cljs.core.next(cvec_nl);
var G__35152 = (idx + (1));
var G__35153 = start;
var G__35154 = out;
cvec_nl = G__35151;
...
var G__35155 = cljs.core.next(cvec_nl);
var G__35156 = (idx + (1));
var G__35157 = idx;
var G__35158 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__35155;
idx = G__35156;
start = G__35157;
out = G__35158;
...
var G__35159 = cljs.core.next(cvec_nl);
var G__35160 = (idx + (1));
var G__35161 = (idx + (1));
var G__35162 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__35159;
idx = G__35160;
start = G__35161;
out = G__35162;
...
var G__35163 = cljs.core.next(cvec_nl);
var G__35164 = (idx + (1));
var G__35165 = idx;
var G__35166 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__35163;
idx = G__35164;
start = G__35165;
out = G__35166;
...
var G__35168 = cljs.core.next(cvec_nl);
var G__35169 = (idx + (1));
var G__35170 = start;
var G__35171 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__35168;
idx = G__35169;
start = G__35170;
out = G__35171;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__35059_SHARP_,p2__35058_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__35058_SHARP_)){
return cljs.core.reduced(p1__35059_SHARP_);
} else {
return (p1__35059_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__35062,p__35063){
var vec__35064 = p__35062;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35064,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35064,(1),null);
var vec__35067 = p__35063;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35067,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35067,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__35081,cvec,focus_vec){
...
var map__35083 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35082__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35083__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35083__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35083__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35077_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__35077_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
