...
var o28026 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28026["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28027 = temp__5733__auto____$1;
return (o28027["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27533__auto__ = f;
return (o__27533__auto__["toString"]).call(o__27533__auto__);
} else {
return "";
}
}catch (e28028){var _ = e28028;
return "";
}});
...
try{var o__27533__auto___28214 = t;
(o__27533__auto___28214["cljs$lang$ctorPrWriter"]).call(o__27533__auto___28214,t,writer);
}catch (e28030){var __28215 = e28030;
}
...
var char_code = (function (){var o__27533__auto__ = (new String(char$));
return (o__27533__auto__["charCodeAt"]).call(o__27533__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27533__auto__ = String;
return (o__27533__auto__["fromCharCode"]).call(o__27533__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28038 = num_code;
switch (G__28038) {
case (1):
return (185);
...
var o__27533__auto__ = String;
return (o__27533__auto__["fromCharCode"]).call(o__27533__auto__,superscript_code);
});
/**
...
}catch (e28059){var _e__27562__auto__ = e28059;
return false;
}})())){
...
var vec__28060 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28060,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28073 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28073["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28074 = temp__5733__auto____$1;
return (o28074["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4789__auto___28224 = arguments.length;
var i__4790__auto___28225 = (0);
while(true){
if((i__4790__auto___28225 < len__4789__auto___28224)){
args__4795__auto__.push((arguments[i__4790__auto___28225]));

var G__28226 = (i__4790__auto___28225 + (1));
i__4790__auto___28225 = G__28226;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28080){
var vec__28082 = p__28080;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28082,(0),null);
...
var G__28232 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28233 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28232;
remaining_tokens = G__28233;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28076){
var G__28077 = cljs.core.first(seq28076);
var seq28076__$1 = cljs.core.next(seq28076);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28077,seq28076__$1);
}));
...
var vec__28088 = cljs.core.split_with((function (p1__28087_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28087_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28088,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28088,(1),null);
...
var vec__28097 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28097,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28097,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28241 = cljs.core.rest(remaining_tokens);
var G__28242 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28241;
name_tokens = G__28242;
continue;
} else {
...
var vec__28102 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28102,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28102,(1),null);
var vec__28105 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28105,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28105,(1),null);
var vec__28108 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(3),null);
...
var vec__28117 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28117,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28117,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28117,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28117,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28117,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28117,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28120 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28120,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28120,(1),null);
var vec__28123 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28123,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28123,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28126 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28126) : devtools.munging.parse_fn_info_deep.call(null,G__28126));
})()));
}
} else {
return fn_info;
...
var G__28264 = (arity + (1));
var G__28265 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28127){
var vec__28128 = p__28127;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28128,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28128,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28132_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28132_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28133_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28133_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___28271 = arguments.length;
var i__4790__auto___28272 = (0);
while(true){
if((i__4790__auto___28272 < len__4789__auto___28271)){
args__4795__auto__.push((arguments[i__4790__auto___28272]));

var G__28274 = (i__4790__auto___28272 + (1));
i__4790__auto___28272 = G__28274;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28144){
var vec__28145 = p__28144;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28145,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28134){
var G__28135 = cljs.core.first(seq28134);
var seq28134__$1 = cljs.core.next(seq28134);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28135,seq28134__$1);
}));
...
var map__28163 = options;
var map__28163__$1 = (((((!((map__28163 == null))))?(((((map__28163.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28163.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28163):map__28163);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28163__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28163__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28163__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28163__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28164 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28164,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28164,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28164,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28164,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28164,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28164,(5),null);
...
var o__27533__auto__ = f;
return (o__27533__auto__["getBasis"]).call(o__27533__auto__);
});
/**
...
}catch (e28174){var _e__27562__auto__ = e28174;
...
var G__28316 = (obj[cljs.core.first(path)]);
var G__28317 = cljs.core.rest(path);
obj = G__28316;
path = G__28317;
continue;
} else {
...
var _STAR_ = (function (accum,p__28190){
var vec__28191 = p__28190;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28191,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28191,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28195){
var vec__28196 = p__28195;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(2),null);
...
var post_process = (function (p__28204){
var vec__28205 = p__28204;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28205,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28205,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28199_SHARP_){
return (obj[cljs.core.first(p1__28199_SHARP_)]);
}),sorted_matches);
